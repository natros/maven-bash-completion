...
_mvn()
{
    ...
    local plugin_goals_quarkus="quarkus:add-extension|quarkus:add-extensions|quarkus:analyze-call-tree|quarkus:build|quarkus:create|quarkus:create-extension|quarkus:dev|quarkus:generate-config|quarkus:help|quarkus:list-extensions|quarkus:native-image|quarkus:remote-dev"
    ...
    local plugin_goals_versions="versions:commit|versions:compare-dependencies|versions:dependency-updates-report|versions:display-dependency-updates|versions:display-parent-updates|versions:display-plugin-updates|versions:display-property-updates|versions:force-releases|versions:help|versions:lock-snapshots|versions:plugin-updates-report|versions:property-updates-report|versions:resolve-ranges|versions:revert|versions:set|versions:set-property|versions:set-scm-tag|versions:unlock-snapshots|versions:update-child-modules|versions:update-parent|versions:update-properties|versions:update-property|versions:use-dep-version|versions:use-latest-releases|versions:use-latest-snapshots|versions:use-latest-versions|versions:use-next-releases|versions:use-next-snapshots|versions:use-next-versions|versions:use-reactor|versions:use-releases"
    ...
    local options="-Dmaven.test.skip=true|-DskipTests|-DskipITs|-Dtest|-Dit.test|-DfailIfNoTests|-Dmaven.surefire.debug|-DenableCiProfile|-Dpmd.skip=true|-Dcheckstyle.skip=true|-Dtycho.mode=maven|-Dmaven.javadoc.skip=true|-Dcobertura.skip=true|-Dfindbugs.skip=true|-DperformRelease=true|-Dgpg.skip=true|-DforkCount|-Dgoal=|-Ddetail|-DignoreNonCompile|-DoutputXML|-Dliquibase.rollbackTag=|-Dliquibase.rollbackCount=|-Dliquibase.changesToApply=|-Dliquibase.contexts=|-DprocessDependencyManagement=|-Dincludes=|-DnewVersion=|-DignoreSnapshots|-DdryRun|-DallowSnapshots|-Dgwt.draftCompile|Dgwt.failOnError|-Dgwt.forceCompilation|-Dgwt.localWorkers|-Dgwt.logLevel|-Dgwt.logLevel|-Dgwt.logLevel|-Dgwt.modules|-Dgwt.modules|-Dgwt.optimize|-Dgwt.projects|-Dgwt.projects|-Dgwt.skipCompilation|-Dgwt.style|-Dexpression=|-Dassembly.skipAssembly|-Denforcer.skip|-Dmaven.compiler.useIncrementalCompilation=false|-DgroupId=|-DartifactId=|-DarchetypeGroupId=|-DarchetypeArtifactId=|-DarchetypeVersion=|-Dversion=|-DinteractiveMode=false|-Drevision=|-Denv=prod|-Dproperty="
